...
export default function Dashboard ({ params }: { params: { delegator: string } }){
  ...
  const getChainData = async () => {
    const delegatorsData = await axios.get('https://monitor.vn.stakepool.dev.br/api/delegatorsData')
    ...
    const delegatedData = await axios.get('https://monitor.vn.stakepool.dev.br/api/totalDelegatedData')
